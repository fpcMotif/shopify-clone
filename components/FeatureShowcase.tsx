        ...
        <div className="relative w-full h-[400px] md:h-[600px]">
          ...
          >
            ...
            <div className="min-w-[80%] md:min-w-[60%] lg:min-w-[45%] h-full rounded-2xl overflow-hidden relative group">
                <img src={images[activeTab]} alt="Feature" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                <div className="absolute bottom-0 left-0 w-full p-6 bg-gradient-to-t from-black/80 to-transparent">
                    <p className="text-white font-bold">Example Store</p>
                </div>
            </div>
            <div className="min-w-[40%] md:min-w-[30%] lg:min-w-[25%] h-full rounded-2xl overflow-hidden relative bg-[#1a1a1a] flex items-center justify-center">
                 <img src={images[(activeTab + 1) % images.length]} alt="Secondary" className="w-full h-full object-cover opacity-60" />
            </div>
             <div className="min-w-[40%] md:min-w-[30%] lg:min-w-[35%] h-full rounded-2xl overflow-hidden relative bg-[#1a1a1a] flex items-center justify-center">
                 <img src={images[(activeTab + 2) % images.length]} alt="Tertiary" className="w-full h-full object-cover opacity-60" />
            </div>
          </motion.div>
        </div>
      </div>
