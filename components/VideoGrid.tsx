  ...
  return (
    <section className="py-24 bg-shopify-dark text-white">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="mb-16">
          <span className="text-shopify-green font-medium mb-2 block text-xl">Online and in person</span>
          <h2 className="text-4xl md:text-5xl font-bold">Sell here, there, and everywhere</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[400px]">
          ...
          <div className="md:col-span-3 rounded-2xl overflow-hidden relative group border border-white/10 bg-shopify-pine">
            ...
            <div className="absolute bottom-0 left-0 w-full p-8 z-10 bg-gradient-to-t from-black/90 to-transparent">
                ...
                <p className="text-gray-300 max-w-lg">Design fast with AI, choose a stylish theme, or build completely custom for full control.</p>
            </div>
          </div>
          ...
          <div className="md:col-span-1 rounded-2xl overflow-hidden relative group border border-white/10 bg-shopify-pine">
            ...
            <div className="absolute bottom-0 left-0 w-full p-8 z-10 bg-gradient-to-t from-black/90 to-transparent">
              <h3 className="text-xl font-bold mb-2 flex items-center gap-2">
                In-person POS <ArrowRight size={16} className="opacity-0 group-hover:opacity-100 transition-opacity" />
              </h3>
              <p className="text-gray-300 text-sm">Sell face to face and keep offline and online sales in sync.</p>
            </div>
          </div>
          ...
          <div className="md:col-span-1 rounded-2xl overflow-hidden relative group border border-white/10 bg-shopify-pine">
             <img 
               ...
               />
            <div className="absolute bottom-0 left-0 w-full p-8 z-10 bg-gradient-to-t from-black/90 to-transparent">
              <h3 className="text-xl font-bold mb-2">Publish across channels</h3>
              <p className="text-gray-300 text-sm">Show up where shoppers scroll, search, and shop.</p>
            </div>
          </div>
          ...
          <div className="md:col-span-1 rounded-2xl overflow-hidden relative group border border-white/10 bg-shopify-pine flex flex-col">
            <div className="flex-grow flex items-center justify-center bg-[#061a1c] relative overflow-hidden">
            ...
            <div className="p-8 z-10 bg-shopify-pine">
              ...
              <p className="text-gray-300 text-sm">Optimized to close more sales.</p>
            </div>
          </div>
        </div>
      </div>
