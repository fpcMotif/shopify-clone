...
const GlobeSection: React.FC = () => {
  return (
    <section className="py-32 bg-shopify-pine text-white overflow-hidden relative">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12">
            <div className="lg:col-span-5 pt-10">
                <span className="text-shopify-green font-medium mb-2 block text-xl">Local and global</span>
                <h2 className="text-5xl md:text-7xl font-bold mb-8 leading-tight">Grow around the world</h2>
                <p className="text-xl text-gray-300 mb-8">
                    Shopify takes the complexity out of international selling, from delivering products faster and more affordably to localizing your experience with Shopify Markets.
                </p>
                <a href="#" className="text-white border-b border-white/30 pb-1 hover:border-white transition-colors">
            ...
            <div className="lg:col-span-7 relative min-h-[500px]">
                ...
                <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center">
                    ...
                    <div className="w-[600px] h-[600px] rounded-full border border-white/5 absolute animate-[spin_60s_linear_infinite]" />
                    <div className="w-[450px] h-[450px] rounded-full border border-white/10 absolute animate-[spin_40s_linear_infinite_reverse]" />
